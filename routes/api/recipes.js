...
router.get('/popular-recipes', auth, recipesControllers.getRecipesPopular);
...
router.patch('/:recipeId/favorites/true', auth, isValidId, recipesControllers.addFavorites);
// ендпоінт для видалення рецептів авторизованого користувача доданих цим же до обраних
router.patch('/:recipeId/favorites/false', auth, isValidId, recipesControllers.removeFavorites);
